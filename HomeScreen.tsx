...
export default function HomeScreen() {
  ...
  const greeting = useMemo(() => {
    ...
    if (hour < 6) return `Доброй ночи, ${userName}!`;
    if (hour < 12) return `Доброе утро, ${userName}!`;
    if (hour < 18) return `Добрый день, ${userName}!`;
  ...
  const handleActionPress = (action: (typeof QUICK_ACTIONS)[number]) => {
    ...
    switch (action.onPress) {
      case 'generate':
        ...
        break;
      case 'continue':
        showToast('Открываем последний маршрут…');
        setTimeout(() => {
          navigation.navigate('RoutesHistory');
        }, 260);
        break;
      case 'repeat':
        showToast('Выбираем популярный маршрут…');
        setTimeout(() => {
          navigation.navigate('Wizard');
        }, 260);
        break;
        ...
        >
          <ScreenShell>
            ...
            >
              ...
              <WeatherWidget style={{ marginTop: Spacing.lg }} />
            </Animated.View>
              ...
              >
                {QUICK_ACTIONS.map((action, index) => (
                    ...
                    style={[
                      styles.actionCardWrapper,
                      {
                        ...
                        transform: [
                          ...
                          { scale: actionsOpacity.interpolate({
                            inputRange: [0, 1],
                            outputRange: [0.8, 1],
                          })},
                        ],
                  ...
                  >
                    ...
                    >
                      <GlassCard style={styles.actionCard} borderRadius="xxl">
                        <View style={styles.actionContent}>
                          ...
                          >
                            <View style={styles.iconGlow}>
                              <Feather name={action.icon as any} size={22} color="#FFB848" />
                            </View>
                          </LinearGradient>
                          <Text
                            style={[
